About dbxfs-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dbxfs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5559&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dbxfs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dbxfs` can be installed with `conda`:
...
It is possible to list all of the versions of `dbxfs` available on your platform with `conda`:
...
```
mamba search dbxfs --channel conda-forge
```
...
mamba repoquery search dbxfs --channel conda-forge

# List packages depending on `dbxfs`:
mamba repoquery whoneeds dbxfs --channel conda-forge

# List dependencies of `dbxfs`:
mamba repoquery depends dbxfs --channel conda-forge
```
